...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25d366] text-white shadow-lg shadow-navy-950/30 transition-transform hover:scale-110"
    >
      <svg
        className="h-7 w-7"
        viewBox="0 0 24 24"
